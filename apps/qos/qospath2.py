...
def main():
    ...
    parser.add_argument("-a","--add", required=False, dest="action_op", action="store_const", const="add", metavar="add")
    parser.add_argument("-d","--delete", required=False, dest="action_op", action="store_const", const="delete", metavar="delete")
    parser.add_argument("-N","--name", required=True, dest="name")
    parser.add_argument("-J","--json", required=False, dest="obj")
    parser.add_argument("-S","--src-ip", required=False, dest="src_ip")
    parser.add_argument("-D","--dest-ip", required=False, dest="dest_ip")
