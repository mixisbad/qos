...
for sw in switches:
        ...
        queuecmd = queuecmd + "--id=@q0 create queue other-config:max-rate=1000000 -- "
        queuecmd = queuecmd + "--id=@q1 create queue other-config:max-rate=1000000 other-config:min-rate=1000000 -- "
        queuecmd = queuecmd + "--id=@q2 create queue other-config:max-rate=10000000 other-config:min-rate=1000000" 
	print queuecmd
